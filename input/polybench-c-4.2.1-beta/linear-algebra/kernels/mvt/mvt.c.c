...
//////#pragma scop
    ...
    cblas_dgemv(CblasRowMajor, CblasNoTrans, n, n, mkl_alpha, A, n, y_1, 1, mkl_beta, x1, 1);
    cblas_dgemv(CblasRowMajor, CblasTrans, n, n, mkl_alpha, A, n, y_2, 1, mkl_beta, x2, 1);
